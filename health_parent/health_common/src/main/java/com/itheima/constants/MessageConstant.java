...
public class MessageConstant {
    ...
    public static final String QUERY_QUESTION_SUCCESS = "查询题库数据成功";
    public static final String QUERY_QUESTION_FAIL = "查询题库数据失败";
    ...
    public static final String SUMBIT_QUESTIONNAIRE_SUCCESS = "提交问卷成功";
    public static final String SUMBIT_QUESTIONNAIRE_FAIL = "提交问卷失败";
    public static final String SUMBIT_QUESTIONNAIRERESULT_FAIL = "查询问卷结果失败";
    public static final String SUMBIT_QUESTIONNAIRERESULT_SUCCESS = "查询问卷结果成功";
